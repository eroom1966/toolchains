...
#include "../../../../../../../vectors-riscv-none-gcc/lib/gcc/riscv-none-embed/8.1.0/plugin/include/highlev-plugin-common.h"

/* Event names.  */
enum plugin_event
{
# define DEFEVENT(NAME) NAME,
# include "../../../../../../../vectors-riscv-none-gcc/lib/gcc/riscv-none-embed/8.1.0/plugin/include/plugin.def"
# undef DEFEVENT
